package devicedatacontroller

import (
	deviceDataModels "basics/internal/models/device_data"
	devicedataservice "basics/internal/services/device_data"
	"net/http"
...
func CreateDeviceData(c *gin.Context) {
	var input deviceDataModels.DeviceDataInputModel
	...
	response, err := devicedataservice.CreateDeviceData(&input)
